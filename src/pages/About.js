    ...
    <div className="about">
      <div className="info">
        ...
        <p>
          ...
          lat - uwielbiałam oglądać czarno-białe fotografie dziadków, chłonęłam
          czasopisma w poszukiwaniu pięknych kadrów. Z czasem hobby przerodziło
          się w zawód, a kompaktowy aparat zamienił się w profesjonalne
          pełnoklatkowe lusterkowce Nikona, w których jestem zakochana bez
          pamięci.
        </p>{" "}
        <p>
          Jednak to nie pasja do fotografii sprawiła, że zajęłam się{" "}
          <strong>fotografią ślubną</strong> zawodowo, sprawiła to pasja do
          ludzi. Uwielbiam Wasze historie - te małe i duże. Uwielbiam patrzeć na
